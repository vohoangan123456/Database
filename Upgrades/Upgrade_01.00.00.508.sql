INSERT INTO #Description VALUES ('Updated Sp [dbo].[m136_be_UpdateFolderPermissions]')
GO
        ...
        BEGIN TRANSACTION;
            ...
            BEGIN
                ...
                BEGIN
                    ...
                    DELETE [dbo].[tblACL] WHERE 
						iPermissionSetId in (461,462)
						AND iEntityId = @iHandbookId 
                        AND iApplicationId = @iAppicationId 
