INSERT INTO #Description VALUES ('Create procedure [dbo].[m136_be_GetDocumentHearingInformation]')
GO
...
IF OBJECT_ID('[dbo].[m136_be_GetDocumentHearingInformation]', 'p') IS NULL
    EXEC ('CREATE PROCEDURE [dbo].[m136_be_GetDocumentHearingInformation] AS SELECT 1')
GO

ALTER PROCEDURE [dbo].[m136_be_GetDocumentHearingInformation] 
