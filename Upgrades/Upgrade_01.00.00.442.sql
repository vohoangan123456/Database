INSERT INTO #Description VALUES ('add hearing member to SearchFilterTypes')
GO

IF NOT EXISTS (SELECT * FROM dbo.SearchFilterTypes WHERE Id = 7)
BEGIN
	INSERT INTO dbo.SearchFilterTypes(Name) VALUES('HearingMembers')
END
GO
