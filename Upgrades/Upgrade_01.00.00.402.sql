INSERT INTO #Description VALUES ('Modify procedure m136_be_UpdateDocument')
GO
    ...
    BEGIN
		...
		BEGIN
            ...
            BEGIN
				...
				SET @iMaxiMetaInfoDateId = ISNULL((SELECT MAX(mtmit.iMetaInfoDateId) FROM dbo.m136_tblMetaInfoDate mtmit), 1);
