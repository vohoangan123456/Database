INSERT INTO #Description VALUES ('Modify procedure [dbo].[m136_be_DeleteSecurityGroups]')
GO
...
BEGIN
	...
	INNER JOIN dbo.tblSecGroup R ON S.Id = R.iSecGroupId	--to avoid dupplicate the deleted role in RoleLogs
