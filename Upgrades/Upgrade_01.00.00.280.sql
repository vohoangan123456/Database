INSERT INTO #Description VALUES ('Created script for most read report.')
GO
...
BEGIN
	...
	BEGIN
		...
		FROM @resultTable r
		ORDER BY r.MostReadTotal , r.MostReadVersion
	END
	ELSE
	BEGIN
		SELECT TOP(@NumberReturn) r.*
		FROM @resultTable r
		ORDER BY r.MostReadVersion, r.MostReadTotal
	END
END
GO