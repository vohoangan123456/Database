INSERT INTO #Description VALUES ('Fixed: get approver from m136_tblDocument instead of m136_relSentEmpApproval')
GO

IF OBJECT_ID('[Calendar].[m136_be_GetDocumentInformation]', 'p') IS NULL
    EXEC ('CREATE PROCEDURE [Calendar].[m136_be_GetDocumentInformation] AS SELECT 1')
GO
