INSERT INTO #Description VALUES ('Create SP [dbo].[m136_GetAboutDocumentDataForMobile].')
GO
...
BEGIN
	...
	INSERT INTO @returnTable
	VALUES('Gyldig fra',LEFT(CONVERT(VARCHAR, @PublishedDate, 103), 10) )
	INSERT INTO @returnTable
	VALUES('Godkjenner', @Approver)
