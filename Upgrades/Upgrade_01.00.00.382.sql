...
SET Body = '{Creator} har lagt til mer informasjon til avviket, <a href="{Url}" target="_blank">{Title}</a><br/><br/>{AppendInformation}'
WHERE TemplateId = 16 AND Language = 1

UPDATE dbo.MessageTemplateLanguage
SET Body = '{Creator} has added more information to deviation, <a href="{Url}" target="_blank">{Title}</a><br/><br/>{AppendInformation}'
WHERE TemplateId = 16 AND Language = 2